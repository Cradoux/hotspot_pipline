...
cluster_dict["17.9330005646"] += [COLOR, 1.00, 1.000, 0.000] + [ALPHA, 0.6] + [SPHERE, float(-21.9564789851), float(-2.45896168646), float(69.7399321544), float(1.0)]


cluster_dict["17.9330005646"] += [COLOR, 1.00, 0.00, 0.00] + [ALPHA, 0.6] + [SPHERE, float(-23.5), float(-4.5), float(69.5), float(1.0)]

cluster_dict["17.9330005646_arrows"] += cgo_arrow([-23.5,-4.5,69.5], [-25.168,-7.109,69.248], color="red blue", name="Arrows_17.9330005646_1")
