...
cluster_dict["16.8199996948"] += [COLOR, 0.00, 0.00, 1.00] + [ALPHA, 0.6] + [SPHERE, float(13.0), float(0.5), float(10.5), float(1.0)]

cluster_dict["16.8199996948_arrows"] += cgo_arrow([13.0,0.5,10.5], [13.189,2.651,8.477], color="blue red", name="Arrows_16.8199996948_1")

cluster_dict["16.8199996948"] += [COLOR, 0.00, 0.00, 1.00] + [ALPHA, 0.6] + [SPHERE, float(14.0), float(-3.5), float(16.0), float(1.0)]

cluster_dict["16.8199996948_arrows"] += cgo_arrow([14.0,-3.5,16.0], [14.727,-3.737,18.88], color="blue red", name="Arrows_16.8199996948_2")

cluster_dict["16.8199996948"] += [COLOR, 0.00, 0.00, 1.00] + [ALPHA, 0.6] + [SPHERE, float(20.0), float(-1.0), float(9.0), float(1.0)]

cluster_dict["16.8199996948_arrows"] += cgo_arrow([20.0,-1.0,9.0], [19.42,1.797,8.962], color="blue red", name="Arrows_16.8199996948_3")
