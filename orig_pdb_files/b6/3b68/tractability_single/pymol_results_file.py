...
cluster_dict["17.5869998932"] += [COLOR, 1.00, 1.000, 0.000] + [ALPHA, 0.6] + [SPHERE, float(27.4056881792), float(2.37682571046), float(5.48784111326), float(1.0)]
...
if dirpath:
    f = join(dirpath, "label_threshold_17.5869998932.mol2")
else:
    f = "label_threshold_17.5869998932.mol2"
