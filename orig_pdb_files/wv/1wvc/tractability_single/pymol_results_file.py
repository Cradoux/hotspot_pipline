...
cluster_dict["13.3310003281"] += [COLOR, 1.00, 0.00, 0.00] + [ALPHA, 0.6] + [SPHERE, float(-10.0), float(34.5), float(49.5), float(1.0)]

cluster_dict["13.3310003281_arrows"] += cgo_arrow([-10.0,34.5,49.5], [-7.697,36.724,49.203], color="red blue", name="Arrows_13.3310003281_4")

cluster_dict["13.3310003281"] += [COLOR, 1.00, 0.00, 0.00] + [ALPHA, 0.6] + [SPHERE, float(-8.5), float(29.0), float(53.0), float(1.0)]

cluster_dict["13.3310003281_arrows"] += cgo_arrow([-8.5,29.0,53.0], [-7.337,28.877,55.918], color="red blue", name="Arrows_13.3310003281_5")

cluster_dict["13.3310003281"] += [COLOR, 1.00, 0.00, 0.00] + [ALPHA, 0.6] + [SPHERE, float(-7.5), float(32.0), float(49.5), float(1.0)]

cluster_dict["13.3310003281_arrows"] += cgo_arrow([-7.5,32.0,49.5], [-6.6,34.578,50.608], color="red blue", name="Arrows_13.3310003281_6")
...
if dirpath:
    f = join(dirpath, "label_threshold_13.3310003281.mol2")
else:
    f = "label_threshold_13.3310003281.mol2"
