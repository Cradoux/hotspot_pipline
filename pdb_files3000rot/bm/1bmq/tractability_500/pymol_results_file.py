...
cluster_dict["9.5609998703"] += [COLOR, 1.00, 1.000, 0.000] + [ALPHA, 0.6] + [SPHERE, float(32.6308635184), float(62.4035391985), float(4.81619499279), float(1.0)]


cluster_dict["9.5609998703"] += [COLOR, 1.00, 1.000, 0.000] + [ALPHA, 0.6] + [SPHERE, float(36.8233661757), float(60.3233661757), float(2.96170889714), float(1.0)]
