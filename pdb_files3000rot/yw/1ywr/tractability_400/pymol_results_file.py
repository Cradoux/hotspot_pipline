...
cluster_dict = {"16.4349994659":[], "16.4349994659_arrows":[]}

cluster_dict["16.4349994659"] += [COLOR, 0.00, 0.00, 1.00] + [ALPHA, 0.6] + [SPHERE, float(-1.0), float(-3.0), float(23.5), float(1.0)]

cluster_dict["16.4349994659_arrows"] += cgo_arrow([-1.0,-3.0,23.5], [-4.133,-2.917,23.047], color="blue red", name="Arrows_16.4349994659_1")

cluster_dict["16.4349994659"] += [COLOR, 0.00, 0.00, 1.00] + [ALPHA, 0.6] + [SPHERE, float(2.0), float(3.5), float(19.5), float(1.0)]

cluster_dict["16.4349994659_arrows"] += cgo_arrow([2.0,3.5,19.5], [4.113,5.844,19.273], color="blue red", name="Arrows_16.4349994659_2")

cluster_dict["16.4349994659"] += [COLOR, 0.00, 0.00, 1.00] + [ALPHA, 0.6] + [SPHERE, float(2.5), float(-3.0), float(15.0), float(1.0)]

cluster_dict["16.4349994659_arrows"] += cgo_arrow([2.5,-3.0,15.0], [3.509,-5.374,14.235], color="blue red", name="Arrows_16.4349994659_3")

cluster_dict["16.4349994659"] += [COLOR, 0.00, 0.00, 1.00] + [ALPHA, 0.6] + [SPHERE, float(4.0), float(3.5), float(26.5), float(1.0)]

cluster_dict["16.4349994659_arrows"] += cgo_arrow([4.0,3.5,26.5], [2.411,5.22,24.84], color="blue red", name="Arrows_16.4349994659_4")
...
cmd.group('Pharmacophore_16.4349994659', members= 'label_threshold_16.4349994659')
